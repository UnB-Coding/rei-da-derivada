...
const HeaderComponent = () => {
    ...
    return (
      <div className=" pt-10 flex justify-between items-center px-9 pb-4 bg-white w-full h-32 fixed top-0">
        ...
        <Image className="w-14 h-14" src={logo} alt="Logo do evento" width="45" height="45" />
      </div>
    );
};
