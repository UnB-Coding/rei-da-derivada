...
class CreateGroupsTestCase(TestCase):
    def setUp(self):
        ...
        self.command.content_types = {
            ...
            'player_total_score': self.command.get_content_type(PlayerTotalScore),
        ...
        self.command.permissions = {
            ...
            'player_total_score': self.command.get_permissions(self.command.content_types['player_total_score']),
    ...
    def test_permissions_Event_Admin(self):
        ...
        O grupo Event_Admin deve ter permissões de alterar, deletar e visualizar eventos e todas as permissões de sumula, player_score e player_total_score.
        """
        ...
        should_exist = {
            ...
            'player_total_score': lambda permission: True,
    ...
    def test_permissions_Staff_Manager(self):
        ...
        should_exist = {
            ...
            'sumula': lambda permission: True,
            'player_score': lambda permission: True,
            'player_total_score': lambda permission: 'view' in permission.codename or 'change' in permission.codename,
            'token': lambda permission: False,
        }
    ...
    def test_permissions_Player(self):
        ...
        should_exist = {
            ...
            'player_total_score': lambda permission: 'view' in permission.codename,
            'token': lambda permission: False,
        }
        for key in self.command.permissions:
            for permission in self.command.permissions[key]:
