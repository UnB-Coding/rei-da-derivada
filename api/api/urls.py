...
from .views.views_players import PlayersView, GetPlayerResults, AddPlayersExcel, AddSinglePlayer, EditPlayerData
...
urlpatterns = [
    ...
    path('player/edit/', EditPlayerData.as_view(), name='edit-player'),
    # Rotas de staff
